  ...
  Widget build(BuildContext context) {
    return RoundedHistoryTile(
      ...
      subtitle: validationMode == true
          ...
          : null,
      details: [
        _buildRow('mulai', _formatTime(item.startTime)),
        _buildRow('selesai', _formatTime(item.endTime)),
        _buildStatusRow(),
        _buildRow('deskripsi', item.description ?? '-'),
        if (item.beforeUrl != null || item.afterUrl != null) ...[
          ...
          _buildImagesSection(),
          const SizedBox(height: 8),
          if (validationMode == true) _buildValidateButton(),
        ],
      ],
    );
  }
            ...
            child: Column(
              children: [
                ...
                ImageThumbnail(
                  ...
                  heroTag: 'overtime-before-${item.id}',
                  height: 140,
                ),
              ],
            ),
          ...
          child: Column(
            children: [
              ...
              ImageThumbnail(
                ...
                heroTag: 'overtime-after-${item.id}',
                height: 140,
              ),
            ],
          ),
